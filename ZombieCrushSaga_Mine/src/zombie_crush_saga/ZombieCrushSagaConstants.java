...
public class ZombieCrushSagaConstants {
    ...
    public static final String SPECIAL_STRIPED_TYPE = "SPECIAL_STRIPED_TYPE";
    ...
    public static final String TILE_BOMB_STATE = "TILE_BOMB_STATE";
    ...
    public static final String POWER_UPS_TYPE = "POWER_UPS_TYPE";
    // DIALOG TYPES
    ...
    public static final String SPECIAL_STRIPED_STATE = "SPECIAL_STRIPED_STATE";
    ...
    public static final int BLOOD_COUNT_X = 0;
    public static final int BLOOD_TEXT_OFFSET = 140;
    public static final int POWER_UPS_X = 0;
    ...
    public static final Color SPECIAL_STRIPED_COLOR = new Color(255, 100, 50, 100);
    // WRAPPED CANDIES ARE RED
    public static final Color SPECIAL_WRAPPED_COLOR = new Color(255, 50, 100, 100);
