...
public class ZombieCrushSaga {
    ...
    public static void main(String[] args) {
        try {
            ...
            props.loadProperties(FileLoaderUtils.loadFile(DATA_PATH + UI_PROPERTIES_FILE_NAME), FileLoaderUtils.loadFile(DATA_PATH + PROPERTIES_SCHEMA_FILE_NAME));

            // THEN WE'LL LOAD THE MAHJONG FLAVOR AS SPECIFIED BY THE PROPERTIES FILE
            String gameFlavorFile = DATA_PATH + props.getProperty(ZombieCrushSagaPropertyType.GAME_FLAVOR_FILE_NAME);
            props.loadProperties(FileLoaderUtils.loadFile(gameFlavorFile), FileLoaderUtils.loadFile(DATA_PATH + PROPERTIES_SCHEMA_FILE_NAME));
