...
public class ZombieCrushSagaMiniGame extends MiniGame {
    ...
    public void initGUIControls() {
        ...
        /*
         // ADD BLOOD DISPLAY
         String tileContainer = props.getProperty(ZombieCrushSagaPropertyType.BLOOD_COUNT_IMAGE_NAME);
         sT = new SpriteType(BLOOD_COUNT_TYPE);
         img = loadImage(imgPath + tileContainer);
         sT.addState(VISIBLE_STATE, img);
         s = new Sprite(sT, BLOOD_COUNT_X, 0, 0, 0, INVISIBLE_STATE);
         guiDecor.put(BLOOD_COUNT_TYPE, s);

         // AND POWER UPS DISPLAY
         String timeContainer = props.getProperty(ZombieCrushSagaPropertyType.POWER_UPS_IMAGE_NAME);
         sT = new SpriteType(POWER_UPS_TYPE);
         img = loadImage(imgPath + timeContainer);
         sT.addState(VISIBLE_STATE, img);
         s = new Sprite(sT, POWER_UPS_X, 0, 0, 0, INVISIBLE_STATE);
         guiDecor.put(POWER_UPS_TYPE, s);
    ...
    public void switchToLevelScoreScreen(String levelFile) {
